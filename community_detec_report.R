...
total_com <- c(
  ...
  #mar24
  comm_detection_cohort %>% 
    filter(cd_date >= '2024-03-01' & 
             cd_date <= '2024-03-31') %>% nrow(),
  comm_detection_cohort %>% 
    filter(fever == 1 & cd_date >= '2024-03-01' & 
             cd_date <= '2024-03-31') %>% nrow(),
  comm_detection_cohort %>% 
    filter(malaria_rdt == 1 & cd_date >= '2024-03-01' & 
             cd_date <= '2024-03-31') %>% nrow(),
  #apr24
  comm_detection_cohort %>% 
    filter(cd_date >= '2024-04-01' & 
             cd_date <= '2024-04-30') %>% nrow(),
  comm_detection_cohort %>% 
    filter(fever == 1 & cd_date >= '2024-04-01' & 
             cd_date <= '2024-04-30') %>% nrow(),
  comm_detection_cohort %>% 
  ...
  #jun24
  comm_detection_cohort %>% 
    filter(cd_date >= '2024-06-01' & 
             cd_date <= '2024-06-30') %>% nrow(),
  comm_detection_cohort %>% 
    filter(fever == 1 & cd_date >= '2024-06-01' & 
             cd_date <= '2024-06-30') %>% nrow(),
  comm_detection_cohort %>% 
    filter(malaria_rdt == 1 & cd_date >= '2024-06-01' & 
             cd_date <= '2024-06-30') %>% nrow(),
  #jul24
  comm_detection_cohort %>% 
    filter(cd_date >= '2024-07-01' & 
             cd_date <= '2024-07-31') %>% nrow(),
  comm_detection_cohort %>% 
    filter(fever == 1 & cd_date >= '2024-07-01' & 
             cd_date <= '2024-07-31') %>% nrow(),
  comm_detection_cohort %>% 
    filter(malaria_rdt == 1 & cd_date >= '2024-07-01' & 
             cd_date <= '2024-07-31') %>% nrow(),
  #aug24
  comm_detection_cohort %>% 
    filter(cd_date >= '2024-08-01' & 
             cd_date <= '2024-08-31') %>% nrow(),
  comm_detection_cohort %>% 
    filter(fever == 1 & cd_date >= '2024-08-01' & 
             cd_date <= '2024-08-31') %>% nrow(),
  comm_detection_cohort %>% 
    filter(malaria_rdt == 1 & cd_date >= '2024-08-01' & 
             cd_date <= '2024-08-31') %>% nrow(),
  #sep24
  comm_detection_cohort %>% 
    filter(cd_date >= '2024-09-01' & 
             cd_date <= '2024-09-30') %>% nrow(),
  comm_detection_cohort %>% 
    filter(fever == 1 & cd_date >= '2024-09-01' & 
             cd_date <= '2024-09-30') %>% nrow(),
  comm_detection_cohort %>% 
    filter(malaria_rdt == 1 & cd_date >= '2024-09-01' & 
             cd_date <= '2024-09-30') %>% nrow(),
  #oct24
  comm_detection_cohort %>% 
    filter(cd_date >= '2024-10-01' & 
             cd_date <= '2024-10-31') %>% nrow(),
  comm_detection_cohort %>% 
    filter(fever == 1 & cd_date >= '2024-10-01' & 
             cd_date <= '2024-10-31') %>% nrow(),
  comm_detection_cohort %>% 
    filter(malaria_rdt == 1 & cd_date >= '2024-10-01' & 
             cd_date <= '2024-10-31') %>% nrow()
...
r_names_table <- c(rep(sample_names,  times=17))
